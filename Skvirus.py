...
print
print ("\033[49m                   Welcome To Virus-Sk                     \033[0m")
...
def help():
  print
  print ("\033[44m Developer : ðŸ…¼ðŸ…³-ðŸ†‚ðŸ…°ðŸ…·ðŸ…°ðŸ…³ðŸ…°ðŸ†ƒ-ðŸ…ºðŸ…·ðŸ…°ðŸ…½\033[0m")
  print ("\033[44m Program : VirusSk\033[0m")
  ...
  if dr == "show options":
    ...
    ###########
		...
		if rez == "run":
			...
			print
			print "Now check folder virus on"+R+" /VirusSk/virus/freeze/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/VirusSk/virus/malware/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
  elif dr == "04":
		dea = raw_input(""+N+"Virus"+B+"Sk > ")
		if dea == "run":
			time.sleep(1)
			print ""+B+"[*]"+N+" Downloading virus..."
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/DarkSkploit/virus/Wannadecryptor2/"
			time.sleep(1)
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/VirusSk/virus/sms_tief/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			main()
  elif dr == "07":
		...
		if dea == "run":
			...
			time.sleep(1)
			print
			print "Now check folder virus on "+R+"/VirusSk/virus/malware_enc/"
			time.sleep(1)
			print ""+B+"[*]"+N+"Finished"
			print
			main()
    ...
    time.sleep(6)
    os.system("cd ..;rm -rf VirusSk;git clone https://github.com/TSMaitry/VirusSk;cd VirusX;python2 VirusSk.py")
    main()
  elif dr == "10":
    time.sleep(1)
    print ""+R+"exiting..."
